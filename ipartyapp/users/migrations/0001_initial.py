    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('campus', models.CharField(choices=[('Campus A', 'KU'), ('Campus B', 'JKUAT'), ('Campus C', 'UON')], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('booked_users', models.ManyToManyField(related_name='booked_events', to='users.customuser')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.partyevent')),
            ],
        ),
    ]
